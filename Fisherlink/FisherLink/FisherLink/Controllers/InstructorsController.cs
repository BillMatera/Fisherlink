...
using FisherLink.Models.SchoolViewModels;
    ...
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id, int? courseID)
        {
            ...
            if (id != null)
            {
                ...
                Instructor instructor = viewModel.Instructor.Where(
                    i => i.ID == id.Value).Single();
                viewModel.Course = instructor.CourseAssignments.Select(s => s.Course);
            }

            if (courseID != null)
            {
                ViewData["CourseID"] = courseID.Value;
                viewModel.Enrollment = viewModel.Course.Where(
